    ...
    <section class="panel" id="sec-testimonials">
        ...
        <?php foreach ($testimonials as $t): ?>
            <details class="edit-row">
                ...
                <form method="post" action="<?= admin_url('testimonials/delete') ?>" onsubmit="return confirm('Silinsin mi?')"><input type="hidden" name="_csrf" value="<?= e(csrf_token()) ?>"><input type="hidden" name="id" value="<?= (int) $t['id'] ?>"><button class="danger">Sil</button></form>
            </details>
        <?php endforeach; ?>
        <details class="edit-row create">
